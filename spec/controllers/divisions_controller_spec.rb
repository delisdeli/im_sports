  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved division as @division" do
        ...
        post :create, {:division => { "league" => "invalid value" }}, valid_session
        assigns(:division).should be_a_new(Division)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested division" do
        ...
        Division.any_instance.should_receive(:update_attributes).with({ "league" => "" })
        put :update, {:id => division.to_param, :division => { "league" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the division as @division" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Division.any_instance.stub(:save).and_return(false)
        put :update, {:id => division.to_param, :division => { "league" => "invalid value" }}, valid_session
        assigns(:division).should eq(division)
      end
